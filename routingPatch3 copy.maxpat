...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 525.0, 106.5, 51.0, 76.0 ],
					"text" : "/fingers 221.943588 88.844833"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1099.0, 836.0, 50.0, 35.0 ],
					"text" : "-0.781387 1. 0."
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"patching_rect" : [ 59.0, 141.0, 400.0, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "jit_matrix", "" ],
									"patching_rect" : [ 85.0, 339.0, 446.0, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "jit_matrix", "" ],
									"patching_rect" : [ 33.0, 262.0, 429.0, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "jit_matrix", "" ],
									"patching_rect" : [ 243.0, 18.0, 427.0, 22.0 ],
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 0,
									"offset" : [ 0.0, 0.0 ],
									"patching_rect" : [ 587.0, 22.0, 230.0, 208.0 ],
									"prototypename" : "pixl",
									"varname" : "viewr",
									"viewvisibility" : 1
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 507.0, 52.0, 58.0, 22.0 ],
									"text" : "r video13"
								}
...
, 							{
								"box" : 								{
									...
									"offset" : [ 0.0, 0.0 ],
									"outlettype" : [ "" ],
									"patching_rect" : [ 298.5, 56.021276473999023, 128.0, 130.0 ],
									"prototypename" : "pixl",
									"varname" : "pixl8r",
									"viewvisibility" : 1
								}
...
, 							{
								"box" : 								{
									...
									"offset" : [ 0.0, 0.0 ],
									"outlettype" : [ "" ],
									"patching_rect" : [ 244.5, 466.0, 268.0, 146.0 ],
									"prototypename" : "pixl",
									"varname" : "alphablendr",
									"viewvisibility" : 1
								}
...
, 			{
		...
		"parameters" : 		{
			...
			"obj-68::obj-16::obj-37" : [ "aspect_menu", "aspect_menu", 0 ],
			...
			"obj-68::obj-16::obj-20" : [ "letterbox_menu", "letterbox_menu", 0 ],
